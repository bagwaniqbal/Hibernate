...
public class App 
{
	...
	{
		Book b1 = new Book("Book1",800,"J.K.Rowlings","Available");
		Book b2 = new Book("Book2",300,"Adam Smiths","Available");
		Book b3 = new Book("Book3",750,"Luke Cage","Available");
		Book b4 = new Book("Book4",1000,"B.B.Vines","Not Available");
		Book b5 = new Book("Book5",900,"Luke Harpour","Not Available");
